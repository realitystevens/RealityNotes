...
from project.utils import hash_generate, upload_image_online
...
class Organization(models.Model):
    organization_hash = models.CharField(
        primary_key=True, default="", max_length=3, blank=True, null=False)
    organization_name = models.CharField(
        max_length=1000, blank=False, null=False, default='')
    organization_logo = models.ImageField(
        upload_to='assets/organization', blank=False, null=False, default='')
    organization_logo_alt = models.CharField(
...
class Experience(models.Model):
    experience_id = models.CharField(
        primary_key=True, default="", max_length=5, blank=True, null=False)
    company = models.ForeignKey(
        Organization, on_delete=models.SET_NULL, null=True, blank=False)
    ...
    class Meta:
        ordering = ('company', 'start_date', 'end_date',
                    'is_published', 'experience_id',)
...
class Certification(models.Model):
    certification_hash = models.CharField(
        primary_key=True, default="", max_length=3, blank=True, null=False)
    ...
    class Meta:
        ordering = ('degree', 'institution', 'start_date',
                    'end_date', 'is_published', 'certification_hash',)
